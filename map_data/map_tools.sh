...
#   bash map_data/map_tools.sh gen-routes
#   bash map_data/map_tools.sh view-routes
#   bash map_data/map_tools.sh overlay-points

# bash map_data/map_tools.sh edit-map4robot
# bash map_data/map_tools.sh generate-points-robot
# bash map_data/map_tools.sh add-points-robot
...
所有子命令都支持在后面追加原生 python 参数，例如：
  bash map_data/map_tools.sh gen-routes --interp-step 3.0
  bash map_data/map_tools.sh gen-routes --k-neighbors 12 --max-neighbor-dist 300
EOF
    ;;
