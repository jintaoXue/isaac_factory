...
# 微调（E1–E5）默认 50；hard train（T0/T1 job 28）默认 100（原低点 ~ep70 @ step129万）
HC_MAX_TRAIN_EPISODES="${HC_MAX_TRAIN_EPISODES:-50}"
...
if [ $# -eq 0 ]; then
    ...
    echo "            HC_MAX_TRAIN_EPISODES（默认 50，E1–E5 微调）"
