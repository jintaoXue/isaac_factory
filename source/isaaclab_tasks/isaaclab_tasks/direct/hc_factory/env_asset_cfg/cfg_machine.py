...
CfgMachine = {
    ...
    "num07_gantry_group": {
        ...
        "registration_type": "articulation",
        "corresponding_process_task": ["logistic_for_pipe_cutting", "logistic_for_pipe_grooving", 
            "logistic_for_batch_spot_welding", "logistic_for_arc_welding_root", 
            "logistic_for_MIG_welding_surface", "logistic_for_paint_rust_proof",
            "logistic_for_product_to_storage", "product_to_storage"],
        "num_workstations": 4,
        "num_registration_parts": 1,
