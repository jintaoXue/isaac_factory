...
class num02_weldingRobot(Machine):
    ...
    def __init__(self, env_id: int):
        super().__init__(name="num02_weldingRobot", cfg_machine=CfgMachines["num02_weldingRobot"], env_id=env_id)
...
class num03_rollerbedCNCPipeIntersectionCuttingMachine(Machine):
    ...
    def __init__(self, env_id: int):
        super().__init__(
            ...
            cfg_machine=CfgMachines["num03_rollerbedCNCPipeIntersectionCuttingMachine"],
            env_id=env_id,
        )
...
class num04_laserCuttingMachine(Machine):
    ...
    def __init__(self, env_id: int):
        super().__init__(name="num04_laserCuttingMachine", cfg_machine=CfgMachines["num04_laserCuttingMachine"], env_id=env_id)
...
class num05_groovingMachineLarge(Machine):
    ...
    def __init__(self, env_id: int):
        super().__init__(name="num05_groovingMachineLarge", cfg_machine=CfgMachines["num05_groovingMachineLarge"], env_id=env_id)
...
class num06_groovingMachineSmall(Machine):
    ...
    def __init__(self, env_id: int):
        super().__init__(name="num06_groovingMachineSmall", cfg_machine=CfgMachines["num06_groovingMachineSmall"], env_id=env_id)
...
class num07_highPressureFoamingMachine(Machine):
    ...
    def __init__(self, env_id: int):
        super().__init__(
            ...
            cfg_machine=CfgMachines["num07_highPressureFoamingMachine"],
            env_id=env_id,
        )
...
class num08_gantry_group(Machine):
    ...
    def __init__(self, env_id: int):
        super().__init__(name="num08_gantry_group", cfg_machine=CfgMachines["num08_gantry_group"], env_id=env_id)
...
class num09_workbench(Machine):
    ...
    def __init__(self, env_id: int):
        super().__init__(name="num09_workbench", cfg_machine=CfgMachines["num09_workbench"], env_id=env_id)
