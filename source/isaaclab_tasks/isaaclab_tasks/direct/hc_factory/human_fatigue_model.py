...
from .hc_env_cfg import HcEnvCfg, high_level_task_dic, high_level_task_rev_dic, BoxCapacity
import random
import os
...
class Fatigue(object):
    ...
    def __init__(self, human_idx, human_types, env_cfg : HcEnvCfg, train_cfg) -> None:
...
class Characters(object):
    ...
    def __init__(self, character_list, env_cfg : HcEnvCfg, train_cfg) -> None:
