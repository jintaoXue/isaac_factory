...
class HierarchicalTPA:
    ...
    _VARIANT_KNOB_EXPECT = {
        ...
        "E5-human-match": (False, False, 1.0, 1.0, True, False, True),
        "E5-human-match-c": (False, False, 1.0, 1.0, True, False, True),
        "E5-pair": (False, False, 1.0, 1.0, True, False, True),
        "E5-human-off": (False, False, 1.0, 1.0, True, False, True),
        # G series (gap dynamics): G0=hard teacher; G1=scratch; G2=no-oru; G3=human; G4=match.
        ...
        "G4-c": (False, False, 1.0, 1.0, True, False, True),
