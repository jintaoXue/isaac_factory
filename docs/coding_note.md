...
Hier4TPA 后续算法改进清单（ORU、Rainbow、B-score、信用分配、动态 K 等）见：

→ [`algo_optimization_roadmap.md`](algo_optimization_roadmap.md)

论文侧 HRL survey 引用：`pateria2021hrl`（Pateria et al., ACM CSUR 2021）。
